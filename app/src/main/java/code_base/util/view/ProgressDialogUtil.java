...
public class ProgressDialogUtil {
    ...
    public void createLoadingProgressDialog(String title,String message){
        createLoadingProgressDialog(title,message,true,null);
    }

    public void createLoadingProgressDialog(String title, String message, boolean cancelable, final DialogInterface.OnCancelListener onCancelListener){
        if (dialog == null) {
