 ...
 */
public class SelfRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = SelfRefreshLayout.class.getSimpleName();
...
//                mProgress.start();
                mCircleView.setVisibility(GONE);//使缺省圆圈动画不见
                if (mNotify) {
                    if (mListener != null) {
                        /** 重置关键标志位 */
                        mRefreshing = false;
    ...
    /**
     * Simple constructor to use when creating a SelfRefreshLayout from code.
     *
     * @param context
     */
    public SelfRefreshLayout(Context context) {
        this(context, null);
    }

    /**
     * Constructor that is called when inflating SelfRefreshLayout from XML.
     *
     * @param context
     * @param attrs
     */
    public SelfRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//            startScaleUpAnimation(mRefreshListener);
    ...
    /**
     * Set a callback to override {@link SelfRefreshLayout#canChildScrollUp()} method. Non-null
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed) {
        ...
        // before allowing the match_rv to scroll
    ...
    /**
     * Classes that wish to override {@link SelfRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link SelfRefreshLayout#canChildScrollUp()} method
         * is called to allow the implementer to override its behavior.
         *
         * @param parent SelfRefreshLayout that this callback is overriding.
         * @param child The child view of SelfRefreshLayout.
         *
         * @return Whether it is possible for the child view of parent layout to scroll up.
         */
        boolean canChildScrollUp(SelfRefreshLayout parent, @Nullable View child);
    }
}
